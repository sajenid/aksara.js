(function (global, factory) {
  ...
  (global = global || self, factory((global['@sajenid/aksara'] = global['@sajenid/aksara'] || {}, global['@sajenid/aksara'].js = {})));
  ...
  ****************************/
  ...
  function SuperTrim(str) {
    str = str || "";
    var ret = str.replace(/^\s*|\s*$/g, "").replace(/\s+/g, " ");
    return ret;
  }
  ...
  ****************************/
  ...
  function GetMatra(str) {
    ...
    if (mode == "kopas") matramap = matramap2; //if(mode == "ketik")
  ...
  ****************************/
  ...
  function GetCoreSound(str) {
    ...
    var consonantMap2 = (_consonantMap = {
      A: "ꦄ",
      //A
      B: "ꦨ",
      //B
      ...
      //r
      s: "ꦱ"
    }, _defineProperty(_consonantMap, "\u015B", "ꦯ"), _defineProperty(_consonantMap, "t", "ꦠ"), _defineProperty(_consonantMap, "u", "ꦈ"), _defineProperty(_consonantMap, "v", "ꦮ꦳"), _defineProperty(_consonantMap, "w", "ꦮ"), _defineProperty(_consonantMap, "x", "ꦼ"), _defineProperty(_consonantMap, "\u0115", "ꦼ"), _defineProperty(_consonantMap, "\u011B", "ꦼ"), _defineProperty(_consonantMap, "\xEA", "ꦼ"), _defineProperty(_consonantMap, "\u016B", "ꦹ"), _defineProperty(_consonantMap, "y", "ꦪ"), _defineProperty(_consonantMap, "z", "ꦗ꦳"), _defineProperty(_consonantMap, "\xC8", "ꦌ"), _defineProperty(_consonantMap, "\xC9", "ꦌ"), _defineProperty(_consonantMap, "\xCA", "ꦄꦼ"), _defineProperty(_consonantMap, "\u011A", "ꦄꦼ"), _defineProperty(_consonantMap, "\xE8", "ꦌ"), _defineProperty(_consonantMap, "\xE9", "ꦌ"), _defineProperty(_consonantMap, "\u1E47", "ꦟ"), _defineProperty(_consonantMap, "\u1E0D", "ꦝ"), _defineProperty(_consonantMap, "\u1E6D", "ꦛ"), _defineProperty(_consonantMap, "\u1E63", "ꦰ"), _defineProperty(_consonantMap, "\u1E5B", "ꦽ"), _consonantMap);
    ...
    if (murda == "pakai") consonantMap = consonantMap2; //if(murda == "tidak")
  ...
  ****************************/
  ...
  function GetSound(str) {
    ...
    if (str.length == 1) {
      ...
      var core_sound = GetCoreSound(str); //return "1"+core_sound.CoreSound+"2";
      ...
      if (str.indexOf("nggr") == 0) {
        ...
        if (str[0] == "n" && str[1] == "y" || (str[0] == "t" || str[0] == "d") && str[1] == "h") {
          ...
          if (str[2] == "g") konsonan = "ꦔ꧀ꦒꦽ";else konsonan = "ꦔꦽ";
          matra = ""; //nggrê-/ngrê-
        } else {
        ...
        if (str[0] == "n" && str[1] == "y" || (str[0] == "t" || str[0] == "d") && str[1] == "h") {
          ...
          if (str[2] == "g") konsonan = "ꦔ꧀ꦒ꧀ꦭꦼ";else konsonan = "ꦔ꧀ꦭꦼ";
          matra = ""; //ngglê-/nglê-
        } else if (str[0] == "l") {
          konsonan = "ꦊ";
          matra = ""; //-lê-
      ...
      } else if (core_sound.CoreSound == "ꦛꦿ" || core_sound.CoreSound == "ꦝꦿ" || core_sound.CoreSound == "ꦔꦿ" || core_sound.CoreSound == "ꦚꦿ") {
        // i.e. nyruput
        konsonan = core_sound.CoreSound;
        if (matra == "꧀") matra = "";
  ...
  *****************************************************/
  ...
  function LatinKeAksara(str) {
    ...
    while (i < str.length) {
      ...
      if ((isSpecial(str[i]) || isLW(str[i]) || isCJ(str[i])) && !vowelFlag) ; else if (str[i] == "h" && vowelFlag || !isVowel(str[i]) && i > 0 || str[i] == " " || isPunct(str[i]) || isDigit(str[i]) || i - pi > 5) {
  ...
  exports.DoTransliterate = LatinKeAksara;
  exports.LatinKeAksara = LatinKeAksara;
  exports.LatinToAksara = LatinKeAksara;
